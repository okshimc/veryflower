...
<form name="req_form" method="post" action="req_ok.php" enctype="multipart/form-data">
...
<input type="hidden" name="req_part" value="1">
  ...
  <tr>
	<td height="181" align="center" valign="top"><table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#C6C6C6">
	  <tr height="30" bgcolor="#ffffff">
		...
		<input name="req_name" type="text" class="box" value="" size="20">
		</td>
	  </tr>
	  <tr height="30">
	  ...
	  <tr height="30">
		...
		이메일 </td>
		<td height="12" bgcolor="#FFFFFF">
		<input name="req_email" type="text" class="box" value="" size="40"></td>
	  </tr>
	  <tr height="30">
		<td height="25" bgcolor="#F2F2F2">
		<img src="img/bullet2_1_company.gif" width="3" height="3" hspace="3" align="absmiddle">
		제 목 </td>
		<td height="12" bgcolor="#FFFFFF">
		<input name="req_title" type="text" class="box" value="" size="60"></td>
	  </tr>
	  <tr bgcolor="#FFFFFF" height="30">
		...
		<textarea name="req_content" style="width:350px;height:120px" wrap="hard" class="box"></textarea></td>
	  </tr>
	  <tr height="30">
		<td height="25" bgcolor="#F2F2F2">
		<img src="img/bullet2_1_company.gif" width="3" height="3" hspace="3" align="absmiddle">
  ...
  <tr>
	...
	<a href="javascript:req_check();"><img src="img/ok_button_y1.gif" align="absmiddle" border="0"></a>
	&nbsp;&nbsp;
	<a href="javascript:history.back();"><img src="img/cancel_button_y1.gif" align="absmiddle" border="0"></a>
	</td>
  </tr>
  <tr>
	<td>&nbsp;</td>
