...
<input type="hidden" name="mode" value="<?=$mode?>">
  <tr>
    ...
    <tbody>
		...
		<?php if( strlen($_SESSION[ok_id])<1 || ($_SESSION[ok_id]!=$row[w_id]) ){?>
		<tr>
		...
		<tr>
		  <th scope="row">내용</th>
		  <td>
	  <textarea name="w_content" id="w_content" style="width:90%; height:300px;border:1px solid #eeeeee;"><?=stripslashes($row[w_content])?></textarea>
  ...
  <tr>
    ...
    <div class="btn_board_a">
       <!-- <input type="image" src="img/btn_check.gif" style="border:0px;">-->
        <a href="javascript:edit_chk();" class="btn_board">확인</a>
