...
<!--board_form start-->
<form name="board_form" method="post" action="" enctype="multipart/form-data">
...
<input type="hidden" name="mode" value="input">
  <tr>
    ...
    <tbody>
		...
		<?=$nopart_check_end?>
		<tr>
		  <th scope="row" class="title2">이 름</th>
		  <td class="title2"><input name="name" type="text" value="<?=$_SESSION[ok_name]?>" size="30"></td>
		</tr>
		<?php if(!$_SESSION[ok_id]){?>
		<tr>
		  <th scope="row">비밀번호</th>
		  <td><input name="passwd" type="password" value="" size="30"></td>
		</tr>
		<?php }?>
		<tr>
		  <th scope="row">이메일</th>
		...
		<tr>
		  <th scope="row">제 목</th>
		  <td><input name="title" type="text" value="" size="90"></td>
		</tr>
		<!--
		<?//=$notag_check_start?>
		...
		<tr>
		  ...
		  <td><input type="checkbox" name="lockyn" value="y" class="i"> 비공개로 합니다.</td>
		</tr>
		<?=$nolock_check_end?>
		<tr>
		  <th scope="row">내용</th>
		  <td>
	  <textarea name="w_content" id="w_content" style="width:90%; height:300px;border:1px solid #eeeeee;"></textarea>
...
function setDefaultFont() {
	...
	oEditors.getById["w_content"].setDefaultFont(sDefaultFont, nFontSize);
		...
		<tr>
		  ...
		  <td><input type="file" name="upfile[]" id="" value="파일찾기" style="width:400px;" /></td>
		</tr>
		<?=$noappend_check_end?>
...
<br />
<input type="text" name="zsfCode" id="zsfCode" size="20" />
스팸방지를 위해 보안문자를 입력해주세요.
  ...
  <tr>
    ...
    <div class="btn_board_a">
        ...
        <a href="javascript:write_chk();" class="btn_board">확인</a>
